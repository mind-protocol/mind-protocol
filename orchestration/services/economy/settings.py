...
class EconomySettings:
    ...
    org_id: str = field(default_factory=lambda: os.getenv("ECONOMY_ORG_ID", resolver.org_base()))
    l2_graph: str = field(default_factory=lambda: os.getenv("ECONOMY_L2_GRAPH", resolver.org_base()))
