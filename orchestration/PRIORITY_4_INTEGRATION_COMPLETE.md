...
3. **Entity context derivation** (lines 238-259):
   ...
   - Queries MEMBER_OF memberships for nodes being updated
...
- MembershipQueryHelper with MEMBER_OF querying
...
5. **Membership weighting:** Local updates scaled by MEMBER_OF weights (Σ weight ≤ 1.0 per node)
