...
1. Create directory: `consciousness/citizens/{name}/`
...
**Before contributing:**
1. Read `consciousness/citizens/CLAUDE.md` (team protocols)
2. Check `consciousness/citizens/SYNC.md` (current work)
