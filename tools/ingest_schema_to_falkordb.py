...
MECHANISM_SCHEMAS = [
    ...
    },
    {
        ...
        "description": "Detects when subentities or links haven't been updated within their freshness window",
    ...
    },
    {
        ...
        "description": "Routes created tasks to appropriate citizens/subentities",
        "detection_patterns": [],
        "applicable_link_types": ["ALL"],
