...
IMPL:            mind/connectome/runner.py
...
flows_analysis:
  ...
  - flow_id: cluster_creation
    ...
    triggers:
      - type: event
        source: mind/connectome/steps.py:execute_create
...
```yaml
status:
  stream_destination: .mind-mcp/health/membrane_health.yaml
  result:
    representation: enum
    value: UNKNOWN
...
docks:
  input:
    ...
    location: mind/connectome/runner.py:45
  output:
    id: session_complete
    method: engine.connectome.runner.ConnectomeRunner.continue_session
    location: mind/connectome/runner.py:78
```
...
forwarding:
  targets:
    - location: .mind-mcp/health/membrane_health.yaml
      transport: file
...
docks:
  input:
    ...
    location: mind/connectome/steps.py:15
  output:
    id: step_complete
    method: engine.connectome.steps.execute_step
    location: mind/connectome/steps.py:45
```
...
docks:
  input:
    ...
    location: mind/connectome/steps.py:120
  output:
    id: graph_commit
    method: engine.physics.graph.GraphOps.create_node
    location: mind/physics/graph.py:45
```
