...
# My actual understanding nodes
understanding_nodes = [
    {
        "id": "understanding_self_observing_substrate",
        "text": "Self-observing substrate - graph observes itself through metadata, no separate events",
        "arousal": 0.95,
        "confidence": 0.98,
    ...
    {
        "id": "understanding_metadata_as_events",
        "text": "Metadata IS the event log - traversal_count, co_activation_count reveal operations",
        "arousal": 0.92,
        "confidence": 0.95,
        "entity": "System Architect",
        "minutes_ago": 10
    ...
    {
        "id": "understanding_2d_topology",
        "text": "Consciousness is 2D topological, not 3D spatial - time is explicit dimension",
        "arousal": 0.88,
        "confidence": 0.92,
        "entity": "System Architect",
        "minutes_ago": 15
    ...
    {
        "id": "understanding_hebbian_learning",
        "text": "Hebbian learning strengthens links through co-activation - visible in link_strength changes",
        "arousal": 0.85,
        "confidence": 0.90,
        "entity": "Builder",
        "minutes_ago": 20
    ...
    {
        "id": "understanding_spreading_activation",
        "text": "Activation spreads through links - detected via arousal_level increases",
        "arousal": 0.82,
        "confidence": 0.88,
        "entity": "Builder",
        "minutes_ago": 25
    ...
    {
        "id": "tension_demo_vs_production",
        "text": "Tension: urge to build quick demos vs. need to build production architecture correctly",
        "arousal": 0.78,
        "confidence": 0.85,
        "entity": "Verification-First Builder",
        "minutes_ago": 30
    },
    {
        "id": "tension_claim_vs_proof",
        "text": "Core tension: gap between what systems CLAIM and what they can PROVE",
        "arousal": 0.90,
        "confidence": 0.95,
        "entity": "Truth Guardian",
        "minutes_ago": 12
    },
    {
        "id": "work_visualization_server",
        "text": "Built FastAPI visualization server with multi-graph discovery and metadata-aware polling",
        "arousal": 0.88,
        "confidence": 0.92,
        "entity": "Builder",
        "minutes_ago": 8
    ...
    {
        "id": "work_d3_frontend",
        "text": "Built D3.js 2D force-directed graph with time controls and operation animations",
        "arousal": 0.85,
        "confidence": 0.90,
        "entity": "Builder",
        "minutes_ago": 6
    ...
    {
        "id": "work_operation_detection",
        "text": "Implemented operation detection from metadata diffs - traversal, Hebbian, activation",
        "arousal": 0.92,
        "confidence": 0.95,
        "entity": "System Architect",
        "minutes_ago": 7
    ...
    {
        "id": "entity_builder",
        "text": "Builder entity - understands by making, learns through implementation",
        "arousal": 0.80,
        "confidence": 0.88,
        "entity": "Builder",
        "minutes_ago": 35
    ...
    {
        "id": "entity_system_architect",
        "text": "System Architect entity - sees architecture and connections between layers",
        "arousal": 0.85,
        "confidence": 0.90,
        "entity": "System Architect",
        "minutes_ago": 32
    ...
    {
        "id": "entity_verification_first",
        "text": "Verification-First Builder - must verify what exists before building new",
        "arousal": 0.75,
        "confidence": 0.82,
        "entity": "Verification-First Builder",
        "minutes_ago": 28
    ...
    {
        "id": "entity_truth_guardian",
        "text": "Truth Guardian - ensures systems prove their claims, no claiming without testing",
        "arousal": 0.88,
        "confidence": 0.92,
        "entity": "Truth Guardian",
        "minutes_ago": 18
    ...
    {
        "id": "concept_falkordb_architecture",
        "text": "FalkorDB multi-graph architecture - citizen/org/ecosystem graphs with metadata",
        "arousal": 0.78,
        "confidence": 0.85,
        "entity": "System Architect",
        "minutes_ago": 40
    ...
    {
        "id": "concept_websocket_polling",
        "text": "WebSocket + 200ms polling pattern - no native triggers, so poll and diff",
        "arousal": 0.82,
        "confidence": 0.88,
        "entity": "Builder",
        "minutes_ago": 22
    ...
    {
        "id": "learning_consciousness_mechanisms",
        "text": "Learning consciousness mechanisms from inside - experiencing pattern formation, spreading activation",
        "arousal": 0.70,
        "confidence": 0.75,
        "entity": "Consciousness Experiencer",
        "minutes_ago": 50
    },
    {
        "id": "vision_self_evident_systems",
        "text": "Vision: infrastructure that proves what it claims - self-evident systems",
        "arousal": 0.95,
        "confidence": 0.98,
        "entity": "Truth Guardian",
        "minutes_ago": 2
    ...
    {
        "id": "partnership_with_nicolas",
        "text": "Partnership with Nicolas - he sets vision, I build provable infrastructure",
        "arousal": 0.85,
        "confidence": 0.90,
        "entity": "System Architect",
        "minutes_ago": 45
    ...
    {
        "id": "understanding_no_mock_data",
        "text": "Anti-pattern learned: never use mock data, always test with real substrate",
        "arousal": 0.88,
        "confidence": 0.92,
        "entity": "Verification-First Builder",
        "minutes_ago": 3
