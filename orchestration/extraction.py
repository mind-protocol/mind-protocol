...
Extract nodes (entities) and relations (connections) that match our consciousness schema.
...
- mindstate (string): Internal entity state during formation
...
def extract_and_validate(
    ...
    """
    Extract entities and relations from text, validating against Ada's schema.
    ...
    try:
        ...
        print("[Extraction] Calling LLM for entity/relation extraction...")
