...
1. **Membership weight source:** Currently stubbed in `_get_membership_weights()`. Need to query `BELONGS_TO (Deprecated - now "MEMBER_OF") (Deprecated - now "MEMBER_OF")` links from graph during weight updates.
