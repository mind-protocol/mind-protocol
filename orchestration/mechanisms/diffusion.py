...
def diffusion_tick(
    ...
    """
    Execute one tick of conservative energy diffusion for entity.
    ...
    Args:
        ...
        entity: Entity to diffuse energy for
    ...
    for i, node in enumerate(graph.nodes.values()):
        E[i] = node.get_entity_energy(entity)
    ...
    for i, node in enumerate(graph.nodes.values()):
        node.set_entity_energy(entity, E_new[i])
