...
- When TRACE is not authorized, log discoveries and reasoning in the appropriate project artifact (e.g., `consciousness/citizens/SYNC.md`, specs, or issue trackers).
