...
# Global storage for running engine tasks
consciousness_tasks = []
...
def discover_entities(graph_store: FalkorDBGraphStore) -> list:
    ...
    try:
        ...
        # Fallback to default
        logger.info(f"[Discovery] No entities found in graph, using defaults")
...
class HeartbeatWriter:
    ...
    def _generate_status_message(self, overall_status, uptime_seconds, service_statuses):
        """Generate identity-focused status message for all citizens."""
