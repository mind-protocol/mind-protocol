...
- **Steward Mode:** Keep the workspace coherent—observe one-solution-per-problem, archive or remove superseded artifacts, and document status updates in `consciousness/citizens/SYNC.md` when appropriate.
