...
**Context:** Luca provided complete substrate specifications (Subentity/BELONGS_TO (Deprecated - now "MEMBER_OF")/RELATES_TO schemas, learning formulas, event schemas, bootstrap procedures) in ENTITY_LAYER_ORCHESTRATION_REQUIREMENTS.md. My task was to design HOW these integrate with V2 engine tick cycle.
...
- Phase 4 (EXTENDED): Subentity weight updates, BELONGS_TO (Deprecated - now "MEMBER_OF")/RELATES_TO learning
...
1. Phase 1: Schema migration (Subentity/BELONGS_TO (Deprecated - now "MEMBER_OF")/RELATES_TO) - 2-3 days
