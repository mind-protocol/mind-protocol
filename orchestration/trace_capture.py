...
class TraceCapture:
    ...
    async def _update_entity_activations(
        ...
        """Update entity activation state in personal graph metadata."""
        try:
            # Entity activations are personal state - always write to personal graph
            ...
            logger.debug(f"[TraceCapture] Updated entity activations in personal graph: {activations}")

        except Exception as e:
            logger.error(f"[TraceCapture] Entity activation update failed: {e}")
